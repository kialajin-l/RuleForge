...
exports.clusterPatterns = exports.PatternClusterer = void 0;
    ...
    preprocessEvents(events, options) {
        return events
            ...
            if (options.languageFocus.length > 0) {
                ...
                if (!eventLang)
                    return true;
                return options.languageFocus.some(lang => eventLang.toLowerCase().includes(lang));
            }
            return true;
        })
            .filter(event => {
...
exports.PatternClusterer = PatternClusterer;
// 导出便捷函数
const clusterPatterns = async (events, options) => {
    const clusterer = new PatternClusterer();
    return clusterer.cluster(events, options);
};
exports.clusterPatterns = clusterPatterns;
// 默认导出
exports.default = PatternClusterer;
//# sourceMappingURL=pattern-cluster.js.map